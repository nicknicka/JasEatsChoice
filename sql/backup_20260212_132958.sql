...
) ENGINE=InnoDB AUTO_INCREMENT=699 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='æŽ¨èè®°å½•è¡¨';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `t_dish` (`id`, `merchant_id`, `name`, `category`, `price`, `calorie`, `estimated_cooking_minutes`, `step_template`, `ingredients`, `description`, `image`, `score`, `is_online`, `audit_status`, `audit_comment`, `audit_time`, `audit_admin_id`, `create_time`, `update_time`, `view_count`, `order_count`, `favorite_count`, `avg_rating`, `tags`, `stock`) VALUES (1,7638432224340229,'宫保鸡丁','分类1',38.00,450,15,'NORMAL','{\"optional\": [\"11\", \"1\", \"111\", \"2\"], \"mandatory\": [\"12\", \"3\", \"2\", \"1\"]}','经典川菜',NULL,NULL,1,'APPROVED','ç³»ç»Ÿé»˜è®¤é€šè¿‡ï¼ˆåŽ†å²æ•°æ®ï¼‰','2026-01-31 20:40:30',NULL,'2025-11-22 11:35:20','2026-02-12 11:05:41',0,0,0,NULL,NULL,0),(1001,7638432224340229,'皮蛋瘦肉粥','早餐',12.00,180,15,'NORMAL',NULL,'ç»å…¸ç²¤å¼æ—©é¤ç²¥å“ï¼Œè¥å…»æš–èƒƒ',NULL,NULL,1,'APPROVED','ç³»ç»Ÿé»˜è®¤é€šè¿‡ï¼ˆåŽ†å²æ•°æ®ï¼‰','2026-01-31 20:40:30',NULL,'2026-01-25 09:12:13','2026-01-31 20:40:30',0,0,0,NULL,NULL,100);
...
INSERT INTO `t_menu_dish` VALUES (2021771178267488258,2008415581836992514,1,0,1),(2021771178271682562,2008415581836992514,1001,1,0),(2021789353356931074,2008409035581218818,1,0,0),(2021789353373708289,2008409035581218818,1001,1,0);
...
INSERT INTO `t_user_preference` VALUES (2014594261701468161,3384650106421960,'{}',_binary '\0',NULL,'[]','2026-02-11 10:27:50',1,0,1,1,1),(2015813157733384194,4590322501655448,'{}',_binary '\0',NULL,'[]','2026-01-26 23:44:44',0,1,1,1,1),(2021410848815214593,1,'{}',_binary '\0',NULL,'[]','2026-02-11 10:27:57',1,0,1,1,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=130 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='ç”¨æˆ·è¡Œä¸ºè®°å½•è¡¨';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-02-12 13:29:59
