...
public class AgenticWorkflowConfig {
     ...
     */
    @Bean(destroyMethod = "")
    public ChatLanguageModel workflowChatModel() {
     ...
     */
    @Bean
    public UserPreferenceAgent workflowUserPreferenceAgent(ChatLanguageModel workflowChatModel) {
        log.info("构建L1: UserPreferenceAgent (Agent层级架构)");

        return AiServices.builder(UserPreferenceAgent.class)
                .chatLanguageModel(workflowChatModel)
     ...
     */
    @Bean
    public NutritionGuideAgent workflowNutritionGuideAgent(ChatLanguageModel workflowChatModel) {
     ...
     */
    @Bean
    public DishRecommendationAgent workflowDishRecommendationAgent(ChatLanguageModel workflowChatModel) {
     ...
     */
    @Bean
    public MerchantInfoAgent workflowMerchantInfoAgent(ChatLanguageModel workflowChatModel) {
     ...
     */
    @Bean
    public TimeAwareAgent workflowTimeAwareAgent(ChatLanguageModel workflowChatModel) {
     ...
     */
    @Bean
    public LocationServiceAgent workflowLocationServiceAgent(ChatLanguageModel workflowChatModel) {
     ...
     */
    @Bean
    public OrderHelperAgent workflowOrderHelperAgent(ChatLanguageModel workflowChatModel) {
