<template>
  <view class="dish-add-container">
    ...
    <view class="form-section">
      ...
      <view class="form-item switch-item">
        <view class="switch-info">
          ...
          <text class="desc">开启后菜品将立即在菜单中显示</text>
        </view>
        <switch
    ...
    <view class="action-buttons">
      <button class="action-btn" @tap="saveDraft">保存草稿</button>
      <button class="action-btn primary" @tap="submitDish">发布菜品</button>
    </view>
  </view>
</template>
